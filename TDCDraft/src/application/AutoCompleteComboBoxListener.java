...
/**
 * 
 * This class creates the ability to type letters in to search the ComboBox menu
 * options. We acknowledge and thank Mateus Viccari for his code that enabled us
 * to develop this function. See README for link to his page.
 *
 * @param <T>
 */
