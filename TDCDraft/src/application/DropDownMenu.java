...
public class DropDownMenu {
	...
	public ComboBox<String> populateComboBox() {
		...
		ObservableList<String> menuOptions = FXCollections.observableArrayList("Addis Ababa (UTC+03:00)",
				...
				"Nuuk (UTC-02:00)", "Perth (UTC+08:00)", "Philadelphia (UTC-04:00)", "Reykjavik (UTC+00:00)",
				"Rome (UTC+02:00)", "Salt Lake City (UTC-06:00)", "Santiago (UTC-03:00)", "Sao Paulo (UTC-03:00)",
				"Sydney (UTC+10:00)", "Tehran (UTC+04:30)", "Tokyo (UTC+09:00)", "Toronto (UTC-04:00)",
				"Vancouver (UTC-07:00)", "Yangon (UTC+06:30)");

		// Constructing combo box.
		menuComboBox = new ComboBox<String>(menuOptions);
