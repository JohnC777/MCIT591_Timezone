...
//					reykjavik.pinMaker("REYKJAVÍK", 444, 36.25, "Atlantic/Reykjavik")
			...
			// *** CHELSEA CHANGED ***
			// CheckBox Header
			Label CheckboxHeader = new Label("TIME RESTRICTION FILTERS");
			CheckboxHeader.setTextFill(Color.web("#d3d3d3"));
			CheckboxHeader.setFont(new Font(16.0));
			CheckboxHeader.setLayoutX(28.0);
			CheckboxHeader.setLayoutY(320.0);
			CheckboxHeader.setPrefSize(238.0, 57.0);
			leftPane.getChildren().add(CheckboxHeader);
			
			// Text corresponding to CheckBoxes
			Label CheckboxLabel1 = new Label("General Working Hours: 7:00-15:59");
			CheckboxLabel1.setTextFill(Color.web("#d3d3d3"));
			CheckboxLabel1.setFont(new Font(12.0));
			CheckboxLabel1.setLayoutX(45.0);
			CheckboxLabel1.setLayoutY(360.0);
			CheckboxLabel1.setPrefSize(238.0, 57.0);
			leftPane.getChildren().add(CheckboxLabel1);
			
			Label CheckboxLabel2 = new Label("General Leisure Hours: 18:00-21:59");
			CheckboxLabel2.setTextFill(Color.web("#d3d3d3"));
			CheckboxLabel2.setFont(new Font(12.0));
			CheckboxLabel2.setLayoutX(45.0);
			CheckboxLabel2.setLayoutY(380.0);
			CheckboxLabel2.setPrefSize(238.0, 57.0);
			leftPane.getChildren().add(CheckboxLabel2);
			
			Label CheckboxLabel3 = new Label("General Sleeping Hours: 22:00-06:59");
			CheckboxLabel3.setTextFill(Color.web("#d3d3d3"));
			CheckboxLabel3.setFont(new Font(12.0));
			CheckboxLabel3.setLayoutX(45.0);
			CheckboxLabel3.setLayoutY(400.0);
			CheckboxLabel3.setPrefSize(238.0, 57.0);
			leftPane.getChildren().add(CheckboxLabel3);
			
			// CheckBox
			CheckBox checkbox1 = new CheckBox();
			checkbox1.setLayoutX(26);
			checkbox1.setLayoutY(380);
			checkbox1.setPrefSize(7, 7);
			checkbox1.setPadding(new Insets(0,0,0,0));
			checkbox1.setScaleX(.7);
			checkbox1.setScaleY(.7);
...
//					LocalTime end 	= LocalTime.of(6, 59);					
					...
					for (Pin pin : citiesOnMap.values()) {
						...
						tc.outputFormatterDatePicker(newDateTime);
						tc.outputFormatterTimeSpinner(newDateTime);
						LocalTime newTime = tc.getNewTime();
						if (newTime.compareTo(start) >= 0 && newTime.compareTo(start) <= end) {
							pin.setWorkingHours(true);
						} else {
							pin.setWorkingHours(false);
						}
					}
				}
			});
			leftPane.getChildren().add(checkbox1);

			CheckBox checkbox2 = new CheckBox();
			checkbox2.setLayoutX(26);
			checkbox2.setLayoutY(400);
			checkbox2.setPrefSize(7, 7);
			checkbox2.setPadding(new Insets(0,0,0,0));
			checkbox2.setScaleX(.7);
			checkbox2.setScaleY(.7);
			checkbox2.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent event) {
					...
					for (Pin pin : citiesOnMap.values()) {
						...
						LocalTime newTime = tc.getNewTime();
						if (newTime.compareTo(start) >= 0 && newTime.compareTo(start) <= end) {
							pin.setLeisureHours(true);
						} else {
							pin.setLeisureHours(false);
						}
					}
				}
			});
			leftPane.getChildren().add(checkbox2);
			
			CheckBox checkbox3 = new CheckBox();
			checkbox3.setLayoutX(26);
			checkbox3.setLayoutY(420);
			checkbox3.setPrefSize(7, 7);
			checkbox3.setPadding(new Insets(0,0,0,0));
			checkbox3.setScaleX(.7);
			checkbox3.setScaleY(.7);
			checkbox3.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent event) {
					...
					for (Pin pin : citiesOnMap.values()) {
						...
						LocalTime newTime = tc.getNewTime();
						if (newTime.compareTo(start) >= 0 && newTime.compareTo(start) <= end) {
							pin.setSleepingHours(true);
						} else {
							pin.setSleepingHours(false);
						}
					}
				}
			});
			leftPane.getChildren().add(checkbox3);
			
			
			// Adding the "RESET" button for filters
			Button resetFilter = new Button("RESET");
			resetFilter.setLayoutX(95);
			resetFilter.setLayoutY(470);
			resetFilter.setPrefSize(72.25, 36.5);
			resetFilter.setPadding(new Insets(0, 0, 0, 0));
			resetFilter.setFont(new Font(14.0));
			resetFilter.setTextFill(Color.web("#e8e8e8"));
			resetFilter.setStyle("-fx-background-color: rgba(0, 204, 190, 1);");
			leftPane.getChildren().add(resetFilter);
